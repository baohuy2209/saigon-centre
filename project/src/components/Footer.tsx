...
import { Building2, Phone, Mail, MapPin, Facebook, Linkedin, Globe } from 'lucide-react';
        ...
        <div className="py-16 grid lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <p className="text-gray-400 leading-relaxed">
              Vietnam's premier business destination in the heart of Ho Chi Minh City. Setting the standard for commercial excellence since establishment.
            </p>
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                <MapPin className="h-4 w-4 text-amber-400 flex-shrink-0" />
                <span className="text-gray-400 text-sm">65 Le Loi Boulevard, District 1, HCMC</span>
              </div>
              <div className="flex items-center space-x-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-400 text-sm">info@saigoncentre.com</span>
              </div>
            </div>
          </div>
